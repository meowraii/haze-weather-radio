...
func TestResolveEventUsesWatchMetadataBeforeRawNAADSMapping(t *testing.T) {
	...
	info := capingest.AlertInfo{
		...
		EventCodes: []capingest.NameValue{{Name: "profile:CAP-CP:Event:0.4", Value: "tornado"}},
		Parameters: []capingest.NameValue{
