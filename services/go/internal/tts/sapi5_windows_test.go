...
func TestPrepareSAPITextFixesWeatherPronunciations(t *testing.T) {
	got := prepareSAPIText("Winds north at 40 kilometers per hour and 10 kilometres near Windsor.")
